...
function NavigationBarBack({ className, children, ...props }: React.ComponentProps<typeof Button>) {
  return (
    <Button
      variant="glass"
...
function NavigationBarTitle({ className, ...props }: React.ComponentProps<"h2">) {
  return (
    <h2
